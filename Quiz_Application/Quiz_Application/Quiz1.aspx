<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quiz1.aspx.cs" Inherits="Quiz_Application.Quiz1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RadioButtonList ID="rtn6" runat="server">
                <asp:ListItem>A. Solid</asp:ListItem>
                <asp:ListItem>B. Liquid</asp:ListItem>
                <asp:ListItem>c. Gas</asp:ListItem>
                <asp:ListItem>D. Plasma</asp:ListItem>
            ...
            <br /><br />
            7.In what year did the Berlin Wall fall, marking a major step toward the reunification of Germany?
            <asp:RadioButtonList ID="rtn7" runat="server">
                <asp:ListItem>A. 1987</asp:ListItem>
                <asp:ListItem>B. 1989</asp:ListItem>
                <asp:ListItem>c. 1990</asp:ListItem>
                <asp:ListItem>D. 1975</asp:ListItem>
            ...
            <br /><br />
            8.Which famous river flows directly through the city of Paris?
            <asp:RadioButtonList ID="rtn8" runat="server">
                <asp:ListItem>A. Thames</asp:ListItem>
                <asp:ListItem>B. Rhine</asp:ListItem>
                <asp:ListItem>c. Senie</asp:ListItem>
                <asp:ListItem>D. Danube</asp:ListItem>
            ...
            <br /><br />
            9.Which of the following animals is native exclusively to Australia in the wild?
            <asp:RadioButtonList ID="rtn9" runat="server">
                <asp:ListItem>A. Giant Pandas</asp:ListItem>
                <asp:ListItem>B. Jagur</asp:ListItem>
                <asp:ListItem>c. Kangoo</asp:ListItem>
                <asp:ListItem>D. Moose</asp:ListItem>
            ...
            <br /><br />
            10.Which cell organelle is commonly referred to as the "powerhouse of the cell"?
            <asp:RadioButtonList ID="rtn0" runat="server">
                <asp:ListItem>A. Ribosome</asp:ListItem>
                <asp:ListItem>B. Nucleus</asp:ListItem>
                <asp:ListItem>c. Mitochondria</asp:ListItem>
                <asp:ListItem>D. Lysosome</asp:ListItem>
            ...
            <br /><br />
            <asp:Button ID="Next" runat="server" Text="Next Quiz->" OnClick="Next_Click" />
            <br /><br />
